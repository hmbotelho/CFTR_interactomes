...
src_pankow2015_wt    <- src_pankow2015_core
src_pankow2015_df    <- src_pankow2015_core
path_pankow2015_core <- paste0(datafolder, "/pankow2015_core.csv")
path_pankow2015_wt   <- paste0(datafolder, "/pankow2015_wt.csv")
...
src_lim2021_wt        <- NA
src_lim2021_df        <- NA
path_lim2021_wt       <- paste0(datafolder, "/lim2021_wt.csv")
path_lim2021_df       <- paste0(datafolder, "/lim2021_df.csv")
...
**wt-CFTR interactome:**\
\* All data: `r n_pankow2015_wt` genes.\
\* After name updating: `r n_pankow2015_wtF` genes.
...
```{r, echo=FALSE}
s_pankow2015core_wt_df <- list(core_interactors = paste(pankow2015_coreF$symbol, pankow2015_coreF$uniprot), 
                               wt_interactors = paste(pankow2015_wtF$symbol, pankow2015_wtF$uniprot),
                               df_interactors = paste(pankow2015_dfF$symbol, pankow2015_dfF$uniprot))

plot(euler(s_pankow2015core_wt_df), shape="ellipse", quantities=list(cex=.8), labels=list(cex=.8))
```
